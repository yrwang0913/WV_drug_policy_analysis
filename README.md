...
Please [click me](https://github.com/yrwang0913/WV_drug_policy_analysis/blob/main/West_Virginia_Drug_Authorisation_Policy.ipynb) to see the project.
...
In this project, we are going to **analyse the impact of the compulsory fill-in the form policy on the anti-psychotic drugs usage**. Did it really lead to a decrease, as planned, in the use of drugs? And what were to expect in the future after the policy intervention?
